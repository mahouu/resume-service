...
public class ContactInfoViewAdapterTest {
    ...
    public void givenContactInfo_thenAdaptToContactInfoView() {
        ...
        ContactInfo contactInfo = new ContactInfo(ANY_EMAIL, ANY_NAME, ANY_SURNAME, ANY_GITURL, ANY_SONARURL, ANY_PHONENUMBER, ANY_RESUMEURL);
        ResumeResponse resumeResponse = new ResumeResponse(contactInfo);
        ContactInfoView expected = new ContactInfoView(ANY_EMAIL, ANY_NAME, ANY_SURNAME, ANY_GITURL, ANY_SONARURL, ANY_PHONENUMBER, ANY_RESUMEURL);
